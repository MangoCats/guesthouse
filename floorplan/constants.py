...
LOVESEAT_NW_E = 21.069284555626372  # NW corner easting (fixed position, F1-centered)
LOVESEAT_NW_N = 16.771024347461168  # NW corner northing (fixed position, F1-centered)
