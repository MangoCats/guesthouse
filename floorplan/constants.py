...
RO1_OFFSET_E_IW9 = 28.0 / 12.0    # 28" east of IW9 east face
...
IW1_DIST_FROM_NORTH = 10.0         # 10' IW1 north face to north inner wall
...
F19_F20_CHORD = 22.0 / 12.0       # 22" chord F19-F20
