...
LOVESEAT_NW_E = 19.08836940850953   # NW corner easting (fixed position, F1-centered)
LOVESEAT_NW_N = 18.995161559549018  # NW corner northing (fixed position, F1-centered)
