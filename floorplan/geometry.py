...
_CHAIN_F5_TO_F18 = [
    ...
    ("L",   11.168809879737),                                  # F12->F13
    ("CW",   2.507553207938, _C13_SWEEP, "C13", 60),          # F13->F14
    ("L",    9.574752512512),                                  # F14->F15
    ("CW",   2.333333333333, _PI_3, "C15", 20),               # F15->F16
    ("L",    4.517161641662),                                  # F16->F17
    ("CW",   2.333333333333, _PI_6, "C17", 20),               # F17->F18
]
