...
WALL_HEIGHT_IN = 80.0   # 6'8" lower walls (all openings)
...
def generate():
    ...
    out.append(f"// Lower walls: 0 to {WALL_HEIGHT_IN:.0f}\" (6'8\") — all openings")
    out.append(f"// Upper wall:  {UPPER_BASE_IN:.0f}\" to {UPPER_TOP_IN:.0f}\" (9'4\") — O4 only")
