...
cp floorplan/floorplan_db.svg    ../www/adu/floorplan_db.svg
...
git -C ../www add adu/floorplan.svg adu/floorplan_minik.svg adu/floorplan_db.svg adu/walls.svg adu/all_walls.svg adu/path_area.svg
