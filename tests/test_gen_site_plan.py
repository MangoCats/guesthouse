...
class TestBuildSitePlanData:
    ...
    def test_min_setback_275(self, sp_data):
        ...
        assert sp_data.min_setback_275 == pytest.approx(24.264775173401, abs=1e-9)
...
EXPECTED_D2 = [
    ("F1", 496107.229071, 198173.336306, 10639.293240, 332416.605415),
    ("F2", 493523.224068, 198941.591204, 10967.629318, 329285.134338),
...
EXPECTED_PF_DIST = [
    ...
    ("P3", "F2", 4.493395621469),
    ("P2", "F6", 4.732910223827),
    ("POB", "F11", 12.085109429734),
    ("P5", "F15", 7.556218622776),
]
...
EXPECTED_P_D2 = [
    ("POB", 390278.721638, 145615.843784, 35145.527995, 281396.715911),
    ("P2", 415022.685281, 183542.681603, 26430.057152, 270053.687760),
    ("P3", 506514.413553, 199033.662691, 9295.146741, 341770.695911),
    ("P4", 486982.027703, 140442.535103, 21053.911346, 377898.051818),
    ("P5", 459097.294753, 118081.820439, 31234.680331, 374246.026984),
    ("T1", 441155.210296, 123452.734229, 30889.847235, 350489.583885),
    ("T2", 400630.719743, 140119.627182, 33534.885566, 295701.324623),
    ("T3", 494090.596752, 164640.418964, 14471.708569, 360653.894515),
    ("PA", 405285.782110, 120010.778944, 37660.088457, 320255.573381),
    ("PX", 502102.633498, 152722.715228, 16601.405096, 380558.306719),
    ("TC1", 417505.338336, 108611.535490, 39901.716190, 344297.035717),
    ("TC2", 371248.379794, 121748.128759, 44979.721760, 288140.639412),
    ("TC3", 531328.755752, 173050.708343, 10506.659793, 390391.297607),
]
