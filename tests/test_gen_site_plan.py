...
class TestBuildSitePlanData:
    ...
    def test_min_setback_216(self, sp_data):
        ...
        assert sp_data.min_setback_216 == pytest.approx(11.466568259602097, abs=1e-9)
...
EXPECTED_D2 = [
    ...
    ("F10", 411537.657872, 134757.496611, 32328.020694, 310791.644035),
    ("F11", 408861.736578, 132680.181185, 33362.033458, 310428.119537),
    ("F12", 407314.852071, 123628.467183, 36135.429151, 318297.352755),
    ("F13", 440252.616275, 125088.963553, 30429.360636, 347839.899717),
    ("F14", 442298.881952, 125362.142610, 30081.491374, 349530.685171),
    ("F15", 473322.792395, 131945.291218, 24795.876649, 373155.113313),
    ("F16", 480263.770245, 135317.832824, 23158.676659, 376539.867565),
    ("F17", 488769.717877, 143388.999194, 20030.990132, 376612.276450),
    ("F18", 490142.593083, 145553.625915, 19303.241193, 375748.982332),
    ("F11a", 402923.315944, 128085.222991, 35749.887808, 309679.454650),
    ("F11b", 402642.455064, 126441.743891, 36253.440821, 311108.236020),
...
EXPECTED_PF_DIST = [
    ...
    ("P2", "F6", 2.867441755675),
    ("POB", "F11", 11.136506747880),
    ("P5", "F15", 7.375015690289),
]
...
EXPECTED_P_D2 = [
    ("POB", 389871.321007, 143802.287880, 35517.994273, 282731.210290),
    ("P2", 411521.274409, 181502.742755, 27316.180725, 268669.332597),
    ("P3", 503775.733969, 199731.049441, 9596.389933, 338512.248209),
    ("P4", 489568.572808, 142132.907962, 20367.969888, 378746.640863),
    ("P5", 463336.862975, 119429.929874, 30353.469444, 376986.719226),
    ("T1", 444270.420891, 124035.862738, 30311.969882, 352890.039439),
    ("T2", 400987.659284, 138826.106575, 33701.145207, 297267.112464),
    ("T3", 494347.203997, 165896.332046, 14217.688584, 359705.537709),
    ("PA", 407865.558364, 119443.578726, 37360.990901, 323239.826934),
    ("PX", 503839.201458, 154589.078420, 16015.870312, 380433.984703),
    ("TC1", 421668.755849, 108782.063354, 39233.436563, 348082.864146),
    ("TC2", 372915.577982, 119938.857345, 45032.978559, 291438.143348),
    ("TC3", 531874.674865, 175344.917341, 10030.788628, 388732.078114),
]
