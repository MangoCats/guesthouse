...
class TestPSeriesDist216:
    ...
    EXPECTED_DIST_216 = 11.008790335614
...
EXPECTED_PF_DIST = [
    ...
    ("P3", "F2", 1.087545209893),
    ("P2", "F6", 4.239508514562),
    ("POB", "F11", 10.623576094189),
    ("P5", "F15", 6.859434514102),
]
...
EXPECTED_P_D2 = [
    ("POB", 386445.054439, 140256.103194, 36968.742049, 283088.132801),
    ("P2", 404368.278790, 177404.340720, 29199.441870, 265839.876127),
    ("P3", 496833.872364, 198311.039106, 10537.690992, 333000.224995),
    ("P4", 488881.727243, 142235.356863, 20376.901531, 377938.496290),
    ("P5", 464763.308522, 119388.253251, 30275.622346, 378480.029945),
    ("T1", 444522.728188, 123146.252656, 30603.974048, 354108.395281),
    ("T2", 398359.573837, 135856.348455, 34900.467483, 297810.949754),
    ("T3", 490923.610306, 165332.661558, 14634.558470, 356839.311913),
    ("PA", 407766.136644, 117404.957599, 38073.986059, 325343.841896),
    ("PX", 502065.710988, 154765.636025, 16069.423199, 378442.442039),
    ("TC1", 423312.737168, 107615.651121, 39531.335156, 351013.537840),
    ("TC2", 372027.085063, 116623.096536, 46239.668868, 294122.377953),
    ("TC3", 528531.166490, 175797.188532, 10090.363310, 384848.327001),
]
