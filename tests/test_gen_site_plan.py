...
class TestBuildSitePlanData:
    ...
    def test_ew_dimension(self, sp_data):
        assert sp_data.ew_dim_ft == pytest.approx(37.2, abs=0.1)
    ...
    def test_min_setback_275(self, sp_data):
        ...
        assert sp_data.min_setback_275 == pytest.approx(24.812469277301, abs=1e-9)
...
EXPECTED_D2 = [
    ...
    ("F2", 488894.473083, 197607.134956, 11661.079499, 325977.232711),
...
class TestPSeriesDist216:
    ...
    EXPECTED_DIST_216 = 11.000000000000
...
EXPECTED_PF_DIST = [
    ...
    ("P3", "F2", 2.977737865010),
    ("P2", "F6", 4.373279187913),
    ("POB", "F11", 10.818029278743),
    ("P5", "F15", 5.993602662995),
]
...
EXPECTED_P_D2 = [
    ("POB", 388107.952519, 141806.784966, 36283.803731, 283069.079764),
    ("P2", 406218.656051, 179142.501673, 28701.982733, 266008.302270),
    ("P3", 498852.501229, 200217.451662, 10208.483458, 333336.902741),
    ("P4", 490625.934285, 143867.347595, 19773.272175, 378000.752213),
    ("P5", 466370.304037, 120883.032457, 29534.781463, 378405.074343),
    ("T1", 446143.249611, 124654.557771, 29876.659073, 354046.965587),
    ("T2", 400013.276983, 137397.835291, 34206.334230, 297782.701782),
    ("T3", 492787.884731, 167084.719674, 14150.996497, 357021.635220),
    ("PA", 409330.231986, 118856.836632, 37290.245003, 325225.986120),
    ("PX", 503880.471587, 156468.180315, 15536.347399, 378575.251520),
    ("TC1", 424830.609237, 109021.306881, 38701.370827, 350849.458791),
    ("TC2", 373552.476514, 118036.271679, 45417.223922, 293965.818287),
    ("TC3", 530459.260488, 177613.066222, 9670.620910, 385094.469882),
]
