...
class TestBuildSitePlanData:
    ...
    def test_min_setback_216(self, sp_data):
        ...
        assert sp_data.min_setback_216 == pytest.approx(11.46522937688997, abs=1e-9)
...
EXPECTED_D2 = [
    ...
    ("F10", 411966.783547, 136949.954533, 31742.054768, 309008.361816),
    ("F11", 409275.891335, 134857.668188, 32761.096614, 308629.866400),
    ("F12", 407646.900038, 125723.847396, 35452.385517, 316416.992828),
    ("F13", 455764.874625, 128244.004802, 27591.091865, 359616.672222),
    ("F14", 457847.325899, 128553.369457, 27279.408201, 361343.643273),
    ("F15", 473322.217114, 131941.067165, 24797.401845, 373159.116053),
    ("F16", 480263.158975, 135313.572782, 23160.165866, 376543.834316),
    ("F17", 488768.985931, 143384.618476, 20032.358662, 376616.122524),
    ("F18", 490141.825148, 145549.209207, 19304.573734, 375752.792418),
    ("F11a", 403303.871187, 130229.110480, 35115.351450, 307847.601999),
    ("F11b", 403008.102546, 128570.723619, 35603.996701, 309261.475607),
...
EXPECTED_PF_DIST = [
    ...
    ("POB", "F11", 10.196068185725),
    ("P5", "F15", 7.372520674303),
]
