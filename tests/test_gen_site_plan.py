...
class TestBuildSitePlanData:
    ...
    def test_min_setback_216(self, sp_data):
        ...
        assert sp_data.min_setback_216 == pytest.approx(11.47099295367451, abs=1e-9)
...
EXPECTED_D2 = [
    ...
    ("F15", 473625.728472, 132013.604839, 24750.254444, 373387.017042),
    ("F16", 480066.698676, 135143.141717, 23230.857126, 376527.886996),
    ("F17", 488858.114974, 143485.120572, 19996.477391, 376601.475707),
    ("F18", 490132.224485, 145493.958735, 19321.252144, 375800.467404),
