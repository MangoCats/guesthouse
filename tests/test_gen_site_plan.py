...
class TestBuildSitePlanData:
    ...
    def test_ns_dimension(self, sp_data):
        assert sp_data.ns_dim_ft == pytest.approx(27.1, abs=0.1)
...
EXPECTED_D2 = [
    ...
    ("F5", 416795.943853, 179717.680609, 25987.620945, 274741.868168),
    ("F6", 409016.006084, 173688.589719, 28046.139816, 272960.291931),
    ("F7", 407890.660380, 164109.675940, 28785.113759, 280173.134182),
    ("F8", 414654.156868, 161486.844708, 27394.055224, 288469.535679),
    ("F9", 415142.063760, 161304.299620, 27299.493900, 289066.935786),
    ("F10", 414052.557187, 135315.670644, 31701.150666, 312536.711246),
    ("F11", 411697.901247, 133156.921261, 32679.934079, 312540.088374),
    ("F12", 412024.803267, 124472.340674, 34994.196220, 321755.478080),
    ("F13", 462043.380212, 130343.193702, 26268.523501, 363577.969632),
    ("F14", 464173.348035, 130784.493380, 25926.998591, 365224.808876),
    ...
    ("F11a", 406480.502508, 128379.199304, 34943.836153, 312614.867728),
    ("F11b", 406539.856641, 126802.378970, 35364.026347, 314288.064691),
