...
class TestBuildSitePlanData:
    ...
    def test_ew_dimension(self, sp_data):
        assert sp_data.ew_dim_ft == pytest.approx(36.9, abs=0.1)
    ...
    def test_min_setback_216(self, sp_data):
        ...
        assert sp_data.min_setback_216 == pytest.approx(11.564148153978, abs=1e-9)

    def test_min_setback_275(self, sp_data):
        """Min F-point distance from 275.08' line."""
        assert sp_data.min_setback_275 == pytest.approx(24.436515372082, abs=1e-9)
...
EXPECTED_D2 = [
    ("F1", 495521.601905, 197791.606063, 10731.082516, 332175.669919),
    ("F2", 492938.067445, 198560.331503, 11059.889136, 329044.669384),
    ("F5", 420838.606355, 179719.724498, 25004.439853, 278299.376286),
    ("F6", 413142.393416, 174161.898380, 26998.680624, 276172.024291),
    ("F7", 410240.846540, 164106.605848, 28215.306684, 282246.099222),
    ("F8", 416948.875071, 161040.766716, 26916.783121, 290916.533349),
    ("F9", 417439.319729, 160860.759394, 26824.759563, 291516.471222),
    ("F10", 416445.315238, 135051.442166, 31303.435327, 314999.082988),
    ("F11", 412655.013396, 131859.471707, 32817.356824, 314725.988264),
    ("F12", 411164.978850, 122864.607666, 35647.602477, 322652.071442),
    ("F13", 441227.728065, 124310.350175, 30577.988049, 349628.118371),
    ("F14", 443277.226039, 124586.761529, 30233.351084, 351322.136122),
    ("F15", 471348.283148, 130535.060308, 25438.540272, 372695.490442),
    ("F16", 478684.780940, 134089.073892, 23682.309484, 376262.449231),
    ("F17", 488073.118896, 142996.156917, 20193.496827, 376315.789441),
    ("F18", 491874.414429, 148970.699361, 18228.873572, 373979.113674),
    ("F19", 492316.916405, 151317.536018, 17575.113544, 372032.295604),
    ("F20", 492632.019325, 154769.838747, 16692.108322, 368870.520378),
    ("F11a", 406713.374222, 127261.294972, 35201.992633, 313974.104836),
    ("F11b", 406442.835335, 125628.137865, 35715.867638, 315413.208198),
...
EXPECTED_PF_DIST = [
    ...
    ("P3", "F2", 1.424000624220),
    ("P2", "F6", 3.977738196263),
    ("POB", "F11", 11.076070106660),
    ("P5", "F15", 5.427840654552),
]
