...
class TestPSeriesDist216:
    ...
    EXPECTED_DIST_216 = 11.007052284923
...
EXPECTED_PF_DIST = [
    ...
    ("P3", "F2", 1.088251725467),
    ("P2", "F6", 4.237770223938),
    ("POB", "F11", 10.621858459450),
    ("P5", "F15", 6.859922317715),
]
...
EXPECTED_P_D2 = [
    ("POB", 386449.076435, 140255.103791, 36967.870208, 283092.573350),
    ("P2", 404372.144870, 177403.185400, 29198.414112, 265844.160759),
    ("P3", 496838.213784, 198310.359126, 10537.138575, 333004.984967),
    ("P4", 488886.435323, 142235.043542, 20376.715773, 377943.622922),
    ("P5", 464768.024431, 119387.947759, 30275.444417, 378485.164406),
    ("T1", 444527.276201, 123145.779269, 30603.628223, 354113.361847),
    ("T2", 398363.709969, 135855.463187, 34899.709777, 297815.504439),
    ("T3", 490928.157962, 165332.187814, 14634.212288, 356844.278121),
    ("PA", 407770.476633, 117404.276188, 38073.432210, 325348.600437),
    ("PX", 502070.415042, 154765.318678, 16069.233415, 378447.564645),
    ("TC1", 423317.258282, 107615.150835, 39530.962432, 351018.477507),
    ("TC2", 372031.187571, 116622.177644, 46238.877539, 294126.899014),
    ("TC3", 528535.894446, 175796.895089, 10090.197429, 384853.473511),
]
