...
class TestPSeriesDist216:
    ...
    EXPECTED_DIST_216 = 10.999999999999
...
EXPECTED_PF_DIST = [
    ...
    ("P3", "F2", 1.266157783721),
    ("P2", "F6", 4.245405689316),
    ("POB", "F11", 10.651992768568),
    ("P5", "F15", 6.676635407029),
]
...
EXPECTED_P_D2 = [
    ("POB", 386813.670373, 140580.872899, 36818.929980, 283100.985666),
    ("P2", 404776.114788, 177768.330489, 29088.849865, 265891.949056),
    ("P3", 497279.356561, 198712.677074, 10464.747187, 333089.946123),
    ("P4", 489270.354611, 142580.138001, 20247.100896, 377971.360588),
    ("P5", 465122.808360, 119703.906859, 30116.694181, 378483.766714),
    ("T1", 444884.433711, 123464.111951, 30447.251568, 354114.337736),
    ("T2", 398726.690343, 136179.618731, 34749.155985, 297822.303191),
    ("T3", 491337.114160, 165702.319183, 14529.634321, 356897.052698),
    ("PA", 408115.022589, 117709.997314, 37904.444000, 325336.964771),
    ("PX", 502469.315602, 155125.394409, 15954.599810, 378490.283583),
    ("TC1", 423652.521625, 107911.589349, 39352.691610, 350997.559228),
    ("TC2", 372366.800235, 116918.965479, 46060.956038, 294106.330057),
    ("TC3", 528958.950695, 176181.126508, 9999.719512, 384920.348137),
]
